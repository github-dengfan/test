...
<table cellspacing="1" cellpadding="3" width="100%">
  ...
  <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><input type="checkbox" name="permission_ids[]" value="<?php echo ($row["id"]); ?>" <?php echo in_array($row['id'],$pids)?'checked':'';?>><?php echo ($row["name-text"]); ?></input><br /><?php endforeach; endif; else: echo "" ;endif; ?>
  <tr>
