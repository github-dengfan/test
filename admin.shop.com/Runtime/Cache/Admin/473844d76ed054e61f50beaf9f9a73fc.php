...
<table cellspacing="1" cellpadding="3" width="100%">
  ...
  <tr>
    ...
    <td>
      <select name="roleids[]" multiple="tue">
        <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><option value="<?php echo ($row["id"]); ?>" <?php echo in_array($row['id'],$arr)?'selected':'';?>><?php echo ($row["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
