...
<form method="post" action="<?php echo U();?>" name="theForm">
  <table cellspacing="1" cellpadding="3" width="100%">
    <tbody>
        <tr>
      <td class="label">品牌名</td>
    </tr>
    <td><input type='text' name='name' maxlength='60' value='<?php echo ($name); ?>'><span class='require-field'>*</span></td>
        <tr>
      <td class="label">品牌网址</td>
    </tr>
    <td><input type='text' name='weburl' maxlength='60' value='<?php echo ($weburl); ?>'><span class='require-field'>*</span></td>
        <tr>
      <td class="label">品牌排序</td>
    </tr>
    <td><input type='text' name='sort' maxlength='60' value='<?php echo ($sort); ?>'><span class='require-field'>*</span></td>
        <tr>
      <td class="label">品牌简介</td>
    </tr>
    <td><input type='text' name='intro' maxlength='60' value='<?php echo ($intro); ?>'><span class='require-field'>*</span></td>
        <tr>
      <td class="label">品牌状态</td>
    </tr>
    <td><input type='radio' class='status' name='status' value='1' > 是<input type='radio' class='status' name='status' value='0' > 否</td>
